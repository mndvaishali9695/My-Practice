...
function addition(){ //parameterless func
 ...
 let result1 = function addition1(){
  return a; // return wil return value(niter?)
  console.log('vaishali...'); // unreachables/code block

}
 function substaraction(a,b){ //a,b parameters/argument parametrised fun
return a-b;
