...
//spread operator on object: do not object
let carDetails = {
    carName: "swift",
    color: "white",
    price: 800000,
...
let car4 = { ...carDetails, ...carDetail3 }
console.log(car4);


Word = "MAHARASHTRA Mumbai";// maharasabbahtra mumbai
...
console.log(addition(10, 20, substaraction)); // callback function
